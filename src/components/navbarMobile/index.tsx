...
import { CloseButton, LinkContent, Logo, MenuButton, MenuPanel, NavLinks, Navigation } from "./styles";
  ...
  return (
    <>
      <Navigation>
        ...
        <MenuButton onClick={toggleMenu}>{isOpen ? <XIcon size={24} weight="bold" /> : <ListIcon size={24} weight="bold" />}</MenuButton>
      </Navigation>
